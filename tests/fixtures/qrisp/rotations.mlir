builtin.module @jasp_module {
  func.func public @main(%arg0: !jasp.QuantumState) -> (tensor<i64>, !jasp.QuantumState) {
    ...
    %11 = arith.constant dense<2.500000e-01> : tensor<f64>
    %12 = jasp.quantum_gate "rz" (%10, %11) , %8 : (!jasp.Qubit, tensor<f64>) , !jasp.QuantumState -> !jasp.QuantumState
    %13 = jasp.quantum_gate "cx" (%7, %10) , %12 : (!jasp.Qubit, !jasp.Qubit) , !jasp.QuantumState -> !jasp.QuantumState
    %14, %15 = jasp.measure %1, %13 : !jasp.QubitArray, !jasp.QuantumState -> tensor<i64>, !jasp.QuantumState
    func.return %14, %15 : tensor<i64>, !jasp.QuantumState
  }
}
