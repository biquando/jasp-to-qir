builtin.module @jasp_module {
  func.func public @main(%arg0: !jasp.QuantumState) -> (tensor<i64>, !jasp.QuantumState)
 {
    ...
    %1, %2 = jasp.create_qubits %0, %arg0 : !jasp.QuantumState, tensor<i64> -> !jasp.Qub
itArray, !jasp.QuantumState
...
uantumState
    ...
    %8 = jasp.quantum_gate "cx" (%4, %7) , %5 : (!jasp.Qubit, !jasp.Qubit) , !jasp.Quant
umState -> !jasp.QuantumState
    %9, %10 = jasp.measure %1, %8 : !jasp.QubitArray, !jasp.QuantumState -> tensor<i64>,
 !jasp.QuantumState
