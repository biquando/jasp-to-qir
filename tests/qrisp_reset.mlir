builtin.module @jasp_module {
  func.func public @main(%arg0: !jasp.QuantumState) -> (tensor<i64>, !jasp.QuantumState) {
    ...
    %9 = jasp.reset %4, %8 : !jasp.Qubit, !jasp.QuantumState -> !jasp.QuantumState
    %10 = jasp.quantum_gate "cx" (%4, %7) , %9 : (!jasp.Qubit, !jasp.Qubit) , !jasp.QuantumState -> !jasp.QuantumState
    %11, %12 = jasp.measure %1, %10 : !jasp.QubitArray, !jasp.QuantumState -> tensor<i64>, !jasp.QuantumState
    func.return %11, %12 : tensor<i64>, !jasp.QuantumState
  }
}